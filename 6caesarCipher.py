...
More info at: https://en.wikipedia.com/wiki/Caesar-cipher
View this code at: https://nostarch.com/big-book-small-python-projecrs
...
# Caesar cipher only works in uppercase letters:
...
# Display the encrypted/decrypted string to the sceen:
print(translated)
